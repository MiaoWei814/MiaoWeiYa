...
![image-20210510231408607](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/202305121748409.png)

### 8.4.3. 直接缓存区

使用 NIO 时，操作系统划出的直接缓存区可以被 java 代码直接访问，只有一份。NIO 适合对大文件的读写操作。

![image-20210510231456550](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/202305121748478.png)
