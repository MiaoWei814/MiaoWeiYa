...
![image-20210917203813895](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210917203813895.png)

**踩坑记录:**
1.我把新建的Controller的包放在其他路径下就是不放在主程序的同级目录下,那么就会发生404,如:


![四、创建第一个springboot项目_第一个_06](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/2019021916031092.png)
...
![image-20210917204039104](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210917204039104.png)

打成jar包后,我们在所在的文件夹下运行该jar包,就可以在任何地方进行访问了:

![image-20210917204143883](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210917204143883.png)

cmd运行:

![image-20210917204320615](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210917204320615.png)
...
<img src="https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210917205036312.png" alt="image-20210917205036312" style="zoom:200%;" />
...
8. ## spring.factories(自动配置的核心文件)
   ...
   ![image-20210918114949624](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210918114949624.png)
...
9. #### WebMvcAutoConfiguration
   ...
   <img src="https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210918150043307.png" alt="image-20210918150043307" style="zoom: 80%;" />
   ...
   ![image-20210918210321016](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210918210321016.png)
   ...
   **结论**:自动配置真正实现是从classPath中搜寻所有的`META-INF/spring.factories`配置文件,并将其中对应的`org.springframework.boot.autoconfigure.`包下的配置项,通过反射实例化为对应标注了`@Configuration`的JavaConfig形式的IOC容器配置类,然后将这些都汇总成为一个实例并加载到IOC容器中。
   ...
   ![image-20210918230144508](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210918230144508.png)

可以发现`@ConditionalOnClass`这个就是一个判断条件,判断条件成立才会加载这个类!比如说这里必须这个jar包存在那么这个类才会生效!

### 3.3 画图解析

![自动装配原理分析](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/%E8%87%AA%E5%8A%A8%E8%A3%85%E9%85%8D%E5%8E%9F%E7%90%86%E5%88%86%E6%9E%90.png)
...
5. 结果:
   ...
   ![image-20210920150833380](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920150833380.png)
...
2. 导入以上注解就会报出一个红色的提示:
   ...
   ![image-20210920151225909](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920151225909.png)
...
4. 运行:
   ...
   ![image-20210920153010506](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920153010506.png)
...
![image-20210920153428362](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920153428362.png)
...
![image-20211028180237435](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211028180237435.png)
...
![image-20210920172738414](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920172738414.png)
...
![image-20210920173007446](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920173007446.png)
...
3. 我们点击`ServerProperties.class`这个类里面:
   ...
   ![image-20210920194007641](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920194007641.png)
...
![image-20210920204453032](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920204453032.png)
...
![image-20210920162655104](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920162655104.png)

常见的一些参数:

Bean Validation 中内置的 constraint:

![img](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/3145530-8ae74d19e6c65b4c)

 Hibernate Validator 附加的 constraint:

![img](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/3145530-10035c6af8e90a7c)
...
![image-20210920162927402](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210920162927402.png)
...
![image-20211123110919964](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211123110919964.png)
...
![image-20210921145653589](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921145653589.png)

说明jquery已经被引进来了,这jquery还是js只不过以jar包的方式给它封装了一层结构

而再回过头来再看:

![image-20210921150028981](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921150028981.png)
...
![image-20210921151044540](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921151044540.png)
...
1. 在resources根目录下新建`public`文件夹然后再新建一个html:
   ...
   ![image-20210921155936243](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921155936243.png)
   
2. 浏览器访问:

   ![image-20210921160036689](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921160036689.png)

   **注意**:第一种方式跟webjars是一样的,也就是说我们可以通过这个的方式去访问webjars下的资源

   ![image-20210921161035561](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921161035561.png)

   ![image-20210921161046286](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921161046286.png)
   ...
   **思考**:既然都能被识别,那么试想如果同时这些文件夹都存放`1.js`那么浏览器会加载哪个文件夹下的资源呢?
   ...
   2. 来看下目录结构:
      ...
      ![image-20210921161250215](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921161250215.png)

   3. 地址栏访问:

      ![image-20210921161313651](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921161313651.png)
...
![image-20210921164347136](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921164347136.png)
...
![image-20210921191415510](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20210921191415510.png)
...
![image-20211009183946649](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211009183946649.png)
...
![image-20211021111906032](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211021111906032.png)
...
2. nginx反向代理(部署)
   ...
   ![image-20211021115444368](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211021115444368.png)
...
![image-20211022111759109](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211022111759109.png)

Origin中会指出当前请求属于哪个域（协议+域名+端口）。服务会根据这个值决定是否允许其跨域。如果服务器允许跨域，需要在返回的响应头中携带下面信息：

![image-20211022111844878](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211022111844878.png)
...
​	![image-20211022112157566](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211022112157566.png)
...
![image-20211022112258191](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211022112258191.png)
...
![image-20211022112414410](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211022112414410.png)
