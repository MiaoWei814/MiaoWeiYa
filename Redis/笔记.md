...
![image-20211009192643907](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211009192643907.png)
...
![image-20211009194241743](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211009194241743.png)
...
![image-20211009212552436](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211009212552436.png)
...
从图中可知:用户并不是直接访问的数据库,而是首先访问的是企业防火墙,或者走一些路由网关,那么通过这个网关就要做一些事情就是负载均衡,然后通过负载均衡去搭上我们的服务器集群,通过DNS做一些轮询,通过服务器我们就去访问我们数据库的一些实例,还有我们的很多的服务器!   ![image-20211010090417721](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010090417721.png)
...
![image-20211010103527312](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010103527312.png)
...
不是拿来存储图形的,是用于存储关系的,比如:朋友圈社交网络,广告推荐!
 ...
 ![image-20211010140906981](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010140906981.png)
...
![image-20211010141235929](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010141235929.png)
...
![image-20211010144442496](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010144442496.png)
...
2. 下载并解压安装包:
   ...
   ![image-20211010145305029](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010145305029.png)

3. 解压后如以下目录:

   ![image-20211010145816869](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010145816869.png)
...
4. 开启Rdis,双击`redis-server.exe`即可
   ...
   ![image-20211010150200975](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010150200975.png)
   ...
   ![image-20211016103434035](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016103434035.png)

5. 使用redis客户端来连接redis

   ![image-20211010150601350](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010150601350.png)
...
![image-20211010151343652](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010151343652.png)
...
![image-20211010152018242](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010152018242.png)
...
![image-20211010153826476](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010153826476.png)
...
![image-20211010171117790](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010171117790.png)

如何查看这些分析呢？

![image-20211010171633047](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010171633047.png)
...
![image-20211010172253285](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010172253285.png)
...
![image-20211010184714617](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010184714617.png)
...
![image-20211010193053218](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010193053218.png)
...
![image-20211010205513293](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211010205513293.png)
...
![image-20211012211029794](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211012211029794.png)
...
![image-20211013144610439](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211013144610439.png)
...
![img](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/22a9518f-e355-315f-8d66-d91af4fda723.jpg)
...
![image-20211013195428497](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211013195428497.png)
...
![image-20211013201637761](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211013201637761.png)
...
![image-20211013205501703](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211013205501703.png)
...
![image-20211013213318116](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211013213318116.png)
...
![image-20211014182406100](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014182406100.png)
...
![image-20211014183220178](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014183220178.png)
...
![image-20211014183829980](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014183829980.png)

geo:

![image-20211014183852518](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014183852518.png)

Hyperloglog:

![image-20211014183934459](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014183934459.png)

Bitmap:

![image-20211014184015586](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014184015586.png)
...
![image-20211014185419371](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014185419371.png)
...
![image-20211014185813550](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211014185813550.png)
...
![image-20211024145000572](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211024145000572.png)
...
# 这里是默认的一些单位设置!
# 1k => 1000 bytes
# 1kb => 1024 bytes  这个只是一种称呼,真正用的还是1k
# 1m => 1000000 bytes
# 1mb => 1024*1024 bytes
# 1g => 1000000000 bytes
...
```bash
################################## SECURITY ###################################
requirepass 123456		# 设置redis密码,默认是为空,一般我们推荐使用命令行设置命令,这里要注意就是前面不能有空格!
```
...
# maxmemory-policy noeviction  # 内存达到上限之后的处理策略
	1、volati1e-lru：从已设置过期时间的数据集（server.db[i].expires）中挑选最近最少使用的数据淘汰
	2. vo1atile-ttl：从已设置过期时间的数据集（server.db[i].expires）中挑选将要过期的数据淘汰
...
![image-20211016084629879](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016084629879.png)
...
![image-20211016090528766](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016090528766.png)
...
2. 我们快速写五个命令,这个时候我们去Redis文件夹中可以看到:
   ...
   ![image-20211016091738923](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016091738923.png)
...
![image-20211016095641596](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016095641596.png)
...
![image-20211016100236460](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016100236460.png)
...
1. 现在我们连上服务器,就可以看见已经生成了aof文件:
   ...
   ![image-20211016103906076](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016103906076.png)

2. 然后现在我们打开客户端,然后执行命令`set k1 v2`,然后我们去看aof文件,因为持久化的策略就是每秒中都要去执行一次

   ![image-20211016104130699](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016104130699.png)

   从图中我们可以看出几个关键词,比如最后一个的v1和k1,这不就是我们刚刚的的set命令吗!也就是写操作!

3. 那如果我们破坏性的去这个配置文件中进行修改,那试想一下启动会怎么样呢?我把最后一行改为`aaaaaaav1`,此时我们开启服务器:

   ![image-20211016105005370](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016105005370.png)
...
4. 修复:
   ...
   ![image-20211016105811804](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016105811804.png)
...
5. 我们完整性的测试一下这个修复的!
   ...
   ![image-20211016110156952](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016110156952.png)
   ...
   ![image-20211016110322777](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016110322777.png)
...
![image-20211016111313008](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016111313008.png)
...
![image-20211024113356402](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211024113356402.png)
...
![image-20211016134920273](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016134920273.png)

下图展示了频道channel1,以及订阅这个频道的三个客户端--client2、client5和client1之间的关系:

![image-20211016135141675](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016135141675.png)

当有新消息通过publish命令发送给频道channel1时,这个消息就会被发送给订阅它的三个客户端:

![image-20211016135257186](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016135257186.png)
...
![image-20211016135931447](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016135931447.png)
...
![image-20211016145149681](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016145149681.png)
...
![image-20211016151742089](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016151742089.png)
...
![image-20211016155827271](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016155827271.png)

然后我们分别启动对应的客户端:

```bash
redis-cli -h ip地址 -p 端口号  # 当然我们可以省略掉-h ip地址,如果省掉就是默认为本机IP地址!
```
...
![image-20211016162818866](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016162818866.png)
...
![image-20211016182456740](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016182456740.png)

也可以用这个模型:

> 层层链路模型(名字自己想的)

![image-20211016182755119](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016182755119.png)
...
![image-20211016190520522](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016190520522.png)
...
![image-20211016191246006](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016191246006.png)
...
`缓存穿透是指,请求的是缓存和数据库中都没有的数据！`			

画图理解：

![image-20211016205959215](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016205959215.png)
...
（这个方案最大的问题就是`不支持反向删除`操作，也就是说假如现在活跃的key数量有1千万个，但是全部key数量有5千万个，那么这5千万个key就会全部存储在布隆顾虑器里，而且直到某一天你就会发现这个过滤器太拥挤了，并且`误判率太高`，这时就不得不重建！）

![image-20211016205554797](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016205554797.png)

​	**缓存空对象**

​	当存储层不命中后,即使返回的空对象也将其缓存起来,同时会设置一个过期时间,之后再访问这个数据库将会从缓存中获取,保护了后端数据源;

![image-20211016211435241](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016211435241.png)
...
spring:
  cache:
    redis:
      time-to-live: 3600000 # 指定过期时间
      key-prefix: CHCHE_ # 如果指定了前缀，如果没有就默认使用缓存得名字作为前缀
...
2. 加互斥锁
   - 分布式锁：使用分布式锁，保证对于`每个key同一时间只有一个线程去查询后端服务`，其他线程没有获得分布式锁的权限，因此只需要等待即可，这种方式高并发的压力转移到了分布式锁，因为对分布式锁的考验很大！使用我们之前用过的命令。`setnx`,不存在即创建!根据这个返回状态-成功来操作否则
...
![image-20211016222004265](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016222004265.png)
...
![image-20211016222745301](https://springcloud-hrm-miao.oss-cn-beijing.aliyuncs.com/markdown/imgs/image-20211016222745301.png)
...
1. redis高可用
   - 这个思想的含义是:既然redis有可能挂掉,那我多增几台redis,这样一台挂掉之后其他的还可以继续工作,其实就是搭建的集群(异地多活!)---Redis高可用集群
2. 限流降级
   - 这个解决方案的思想是:在缓存失效后,通过加锁或者队列来`控制读数据库写缓存的线程数量`,比如对某个key只允许一个线程查询数据和写缓存,其他线程等待
3. 数据预热
   - 数据预热的含义就是在正式部署之前,我先把可能的数据先预先访问一遍,这样部分可能大量访问的数据就会加载到缓存中,在即将发生大并发访问前手动触发加载缓存不同的key,`设置不同的过期时间`,让缓存失效的时间点`尽量均匀`!(较常见)，可通过均匀设置过期时间解决，如采用一个较大固定值+一个较小的随机值，5小时+0到1800秒

## 12 面试题:Redis 和 Mysql 数据库数据如何保持一致性

这是相关参考链接:https://www.jianshu.com/p/2edbb48604bd

前言:我们一般查询都先走redis缓存中去查询,然后如果缓存没有再从数据库查询,但是如果修改和删除如何保证redis缓存中是否跟数据库中的数据保持同步呢?
...
1. 先删除然后根据删除返回成功状态来删除redis缓存

2. 延时双删策略:在删除数据库前删除redis,删除后休眠500毫秒再删除redis!  

   ---目的就是控制并发情况下A线程删除缓存在写数据库的同时,被另一个B线程执行发现缓存没有就会去数据库中读取写入到缓存中,那么此时就会造成脏数据!而这种延时删除就会将写入后将redis中脏数据再删除一次!

   - 这种容易出现删除成功后但是极容易删除缓存失败,那么也会造成缓存不一致!

     - 我们可以将删除redis的key以`消息队列`的形式发送到消费者,然后重试删除操作,直到删除成功!
       - 坏处:造成代码的耦合度很高!

     - 我们在操作数据库之后将操作信息写入到日志中然后用代码去`监听这个日志`,获取其中更新的操作,一旦有那么就将这个消息以MQ消息队列发送,然后从消息队列中获取该消息然后重试删除!
