...
```java
package com.beoka.iot.common.utils;
...
import com.beoka.iot.common.utils.file.UploadVo;
...
public class VoidUtils {
	 ...
	 */
	public static Integer readVideoTimeMs(MultipartFile file) {
	 ...
	 */
	public static UploadVo fileVideoInfo(String fileUrl) throws IOException {
		UploadVo vo = new UploadVo();
		File source= getFileByUrl(fileUrl);
		Encoder encoder = new Encoder();
		try {
...
> 经过上面的存在问题，有的时候获取就是为null，通过网络地址去获取就会存在问题，经过检测下面这个更为更稳定一些！且速度更快一点
...
/**
	 ...
	 * @throws IOException ioexception
	 */
	public static void videoInfo(String videoPath) throws IOException {
		File source= getFileByUrl(videoPath); // 这里取调用上面代码块的方法
        // File source = new File(videoPath);
		if (!source.exists()) {
			System.err.println("提示：文件[" + videoPath + "]不存在!");
			return;
		}
		...
		try {
			...
			long duration = mi.getDuration()/ 1000;
			...
			System.out.println("★★★★★★★★★By miaowei at 2023-05-24 16:33★★★★★★★★★");
...
相关文章地址：https://blog.csdn.net/u010164507/article/details/108037821
